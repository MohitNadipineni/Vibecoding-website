      ...
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-5 text-balance text-3xl font-semibold tracking-tight text-sovereign-primary dark:text-white sm:text-4xl">
            Get a sandbox and reference architecture.
          </h2>
          <p className="mt-3 text-balance text-sm text-slate-600 dark:text-slate-200 sm:text-base">
            ...
            deployment recommendations, and governance options.
          </p>
        </div>
          ...
          <aside className="glass rounded-2xl p-6">
            ...
            <div className="mt-4 space-y-3 text-sm text-slate-700 dark:text-slate-200">
              <div className="flex items-start gap-3">
                ...
                <p>A sandbox environment and deployment templates.</p>
              </div>
              <div className="flex items-start gap-3">
                <KeyRound className="mt-0.5 h-5 w-5 text-sovereign-accent" />
                <p>Governance primitives and policy controls.</p>
              </div>
            </div>
          </aside>
          ...
          <div className="glass rounded-2xl border border-slate-200/70 p-6 shadow-sm dark:border-white/15 sm:p-8">
            {submitted && (
              <div className="mb-6 rounded-xl border border-emerald-200 bg-emerald-50 p-4 text-sm text-emerald-800 dark:border-emerald-400/25 dark:bg-emerald-500/10 dark:text-emerald-200">
                Request received. We’ll follow up with details.
              </div>
            )}
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <input
                  ...
                  className="w-full rounded-xl border border-slate-200 bg-white/70 px-4 py-3 text-sm outline-none dark:border-white/15 dark:bg-white/5"
              ...
              <textarea
                ...
                rows={5}
                suppressHydrationWarning
                className="w-full resize-none rounded-xl border border-slate-200 bg-white/70 px-4 py-3 text-sm outline-none dark:border-white/15 dark:bg-white/5"
                placeholder="What are you building? *"
              />
              <Button type="submit" size="lg" className="w-full rounded-xl flex items-center justify-center gap-2">
